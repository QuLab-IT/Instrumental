...
class BaslerCamera(Camera):
    ...
    _INST_VISA_INFO_ = (
        "BASLER",
        ["acA2000-165umNIR", "acA2000-165um", "acA2000-340kmNIR", "acA2000-340km"],
    ...
    def _initialize(self, serial=None, model=None, name=None):
        ...
        self._camera.AcquisitionMode.SetValue(
            "Continuous"
    ...
    def wait_for_frame(self, timeout=None):
        ...
        try:
            ...
            if timeout is not None:
                ...
                grab_result = self._camera.RetrieveResult(
                    3600000, pylon.TimeoutHandling_ThrowException
                )
    ...
    def get_captured_image(self, timeout="1s", copy=True):
        ...
        try:
            ...
            timeout_ms = (
                int(timeout * 1000) if timeout is not None else 3600000
            )  # 1 hour timeout
